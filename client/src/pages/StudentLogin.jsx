...
export default function StudentLogin({ defaultSignUp = false }) {
  ...
  const handleGoogleSignIn = async () => {
    try {
      setError(null)
      // Store session/domain/profile in localStorage for post-OAuth redirect
      if (sessionId) localStorage.setItem('pendingQuizSession', sessionId)
      if (domain) localStorage.setItem('pendingDomain', domain)
      if (profile) localStorage.setItem('pendingProfile', profile)
