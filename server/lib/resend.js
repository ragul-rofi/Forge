...
const FROM_EMAIL = 'no-reply@tryforge.site'
 ...
 * @param {string} data.domain - Career domain
 * @param {string} data.sessionId - Quiz session ID
 * @param {string} data.profile - User profile type
 * @param {Object} data.roadmap - Roadmap data (optional)
 * @returns {Promise<Object>} Resend response with email ID
 */
export async function sendQuizResultEmail(toEmail, { name, domain, sessionId, profile, roadmap }) {
